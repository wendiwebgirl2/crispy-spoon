...
export function generateVideo(script, { token = currentToken(), title, avatarId, caption } = {}) {
  return apiPostJson("/api/videos/generate", { token, script, title, avatar_id: avatarId, caption: !!caption });
}
